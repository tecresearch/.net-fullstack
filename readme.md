...
(Collection : Collections & LINQ,
 JDBC : ADO.NET,
 J2EE : ASP.NET Core Basics,
 Banking Web App : Banking Web App in ASP.NET Core)

21/01/2025--04/02/2025 : Hibernate Framework → Entity Framework Core
...
05/02/2025--03/03/2025 : Spring Framework → ASP.NET Core Framework
(IoC : Built-in IoC Container,
 DI : DI (AddScoped/AddTransient/AddSingleton),
 Autowiring : Constructor Injection,
 Spring-JDBC : ADO.NET,
 Spring-ORM : Entity Framework Core,
 Spring-MVC : ASP.NET Core MVC)

04/03/2025--04/04/2025 : Spring Boot → ASP.NET Core Advanced
